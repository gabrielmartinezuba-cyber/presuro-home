...
export const FloatingWhatsApp = () => {
    return (
        <motion.a
            href="https://wa.me/5491124798629"
            target="_blank"
            rel="noopener noreferrer"
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-premium hover:shadow-xl transition-shadow"
